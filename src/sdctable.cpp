...
concept_descriptor conzept::unsealed_concept_descriptor_table[] = {
   ...
   {"ASSUME TIDAL LINE",                     concept_assume_waves,            D, l_c3a,
    UC_none, cr_tidal_line, 0, 0},
   {"ASSUME TIDAL WAVE",                     concept_assume_waves,            D, l_c3a,
    UC_none, cr_tidal_wave, 0, 0},
   {"ASSUME TIDAL COLUMN",                   concept_assume_waves,            D, l_c3a,
   ...
   {"ASSUME COLUMNS",                        concept_assume_waves,            D, l_c3a,
    UC_none, cr_wave_only,  1, 0},
   {"ASSUME RIGHT COLUMNS",                  concept_assume_waves,            D, l_c3a,
    UC_none, cr_wave_only,  1, 1},
   {"ASSUME LEFT COLUMNS",                   concept_assume_waves,            D, l_c3a,
   ...
   {"ASSUME 1/4 BOX",                        concept_assume_waves,            D, l_c3a,
    UC_none, cr_quarterbox, 1, 0},
   {"ASSUME RIGHT 1/4 BOX",                  concept_assume_waves,            D, l_c3a,
    UC_none, cr_quarterbox, 1, 1},
   {"ASSUME LEFT 1/4 BOX",                   concept_assume_waves,            D, l_c3a,
    UC_none, cr_quarterbox, 1, 2},
   {"ASSUME 3/4 BOX",                        concept_assume_waves,            D, l_c3a,
    UC_none, cr_threequarterbox, 1, 0},
   {"ASSUME RIGHT 3/4 BOX",                  concept_assume_waves,            D, l_c3a,
    UC_none, cr_threequarterbox, 1, 1},
   {"ASSUME LEFT 3/4 BOX",                   concept_assume_waves,            D, l_c3a,
   ...
   {"ASSUME GALAXY",                         concept_assume_waves,            D, l_c3a,
    UC_none, cr_galaxy, 0, 0},
   {"ASSUME SPLIT SQUARE THRU SETUP",        concept_assume_waves,            D, l_a1,
