...
concept_descriptor conzept::unsealed_concept_descriptor_table[] = {
   ...
   {"PHANTOM EIGHT CHAIN",                   concept_assume_waves,            D, l_mainstream,
    UC_none, cr_li_lo,      1, 1},
   {"PHANTOM TRADE BY",                      concept_assume_waves,            D, l_mainstream,
    UC_none, cr_li_lo,      1, 2},
   {"PHANTOM DPT",                           concept_assume_waves,            D, l_mainstream,
    UC_none, cr_2fl_only,   1, 1},
   {"PHANTOM CDPT",                          concept_assume_waves,            D, l_mainstream,
    UC_none, cr_2fl_only,   1, 2},
   {"PHANTOM FACING LINES",                  concept_assume_waves,            D, l_mainstream,
    UC_none, cr_li_lo,      0, 1},
   {"PHANTOM BACK-TO-BACK LINES",            concept_assume_waves,            D, l_mainstream,
    UC_none, cr_li_lo,      0, 2},
   {"PHANTOM TWO-FACED LINES",               concept_assume_waves,            D, l_mainstream,
    UC_none, cr_2fl_only,   0, 0},
   {"PHANTOM ONE-FACED LINES",               concept_assume_waves,            D, l_mainstream,
    UC_none, cr_1fl_only,   0, 0},
   {"PHANTOM INVERTED LINES",                concept_assume_waves,            D, l_mainstream,
    UC_none, cr_magic_only, 0, 0},
   {"PHANTOM TIDAL LINE",                    concept_assume_waves,            D, l_mainstream,
    UC_none, cr_tidal_line, 0, 0},
   {"PHANTOM TIDAL WAVE",                    concept_assume_waves,            D, l_mainstream,
    UC_none, cr_tidal_wave, 0, 0},
   {"PHANTOM TIDAL TWO-FACED-LINE",          concept_assume_waves,            D, l_mainstream,
    UC_none, cr_tidal_2fl, 0, 0},
   {"PHANTOM TIDAL COLUMN",                  concept_assume_waves,            D, l_mainstream,
    UC_none, cr_tidal_line, 1, 0},
   {"PHANTOM HOURGLASS",                     concept_assume_waves,            D, l_mainstream,
    UC_none, cr_hourglass, 0, 0},
   {"PHANTOM GALAXY",                        concept_assume_waves,            D, l_mainstream,
    UC_none, cr_galaxy, 0, 0},
   {"PHANTOM SPLIT SQUARE THRU SETUP",       concept_assume_waves,            D, l_mainstream,
    UC_none, cr_split_square_setup, 2, 1},
   {"PHANTOM LIFT-OFF SETUP",                concept_assume_waves,            D, l_mainstream,
    UC_none, cr_liftoff_setup, 2, 1},
   {"PHANTOM I SETUP",                       concept_assume_waves,            D, l_mainstream,
   ...
   {"MATRIX",                                concept_matrix,                G+D, l_c4,
    UC_none},
   {"ASSUME WAVES",                          concept_assume_waves,            D, l_mainstream,
    UC_none, cr_wave_only,  0, 0},
   {"ASSUME MINIWAVES",                      concept_assume_waves,            D, l_mainstream,
    UC_none, cr_miniwaves,  0, 0},
   {"ASSUME COUPLES",                        concept_assume_waves,            D, l_mainstream,
    UC_none, cr_couples_only,0, 0},
   {"ASSUME TWO-FACED LINES",                concept_assume_waves,            D, l_mainstream,
    UC_none, cr_2fl_only,   0, 0},
   {"ASSUME ONE-FACED LINES",                concept_assume_waves,            D, l_mainstream,
    UC_none, cr_1fl_only,   0, 0},
   {"ASSUME INVERTED LINES",                 concept_assume_waves,            D, l_mainstream,
    UC_none, cr_magic_only, 0, 0},
   {"ASSUME TIDAL LINE",                     concept_assume_waves,            D, l_mainstream,
    UC_none, cr_tidal_line, 0, 0},
   {"ASSUME TIDAL WAVE",                     concept_assume_waves,            D, l_mainstream,
    UC_none, cr_tidal_wave, 0, 0},
   {"ASSUME TIDAL TWO-FACED-LINE",           concept_assume_waves,            D, l_mainstream,
    UC_none, cr_tidal_2fl, 0, 0},
   {"ASSUME TIDAL COLUMN",                   concept_assume_waves,            D, l_mainstream,
    UC_none, cr_tidal_line, 1, 0},
   {"ASSUME NORMAL BOXES",                   concept_assume_waves,            D, l_mainstream,
    UC_none, cr_wave_only,  2, 0},
   {"ASSUME INVERTED BOXES",                 concept_assume_waves,            D, l_mainstream,
    UC_none, cr_magic_only, 2, 0},
   {"ASSUME NORMAL COLUMNS",                 concept_assume_waves,            D, l_mainstream,
    UC_none, cr_wave_only,  1, 0},
   {"ASSUME COLUMNS",                        concept_assume_waves,            D, l_mainstream,
    UC_none, cr_wave_only,  1, 0},
   {"ASSUME RIGHT COLUMNS",                  concept_assume_waves,            D, l_mainstream,
    UC_none, cr_wave_only,  1, 1},
   {"ASSUME LEFT COLUMNS",                   concept_assume_waves,            D, l_mainstream,
    UC_none, cr_wave_only,  1, 2},
   {"ASSUME MAGIC COLUMNS",                  concept_assume_waves,            D, l_mainstream,
    UC_none, cr_magic_only, 1, 0},
   {"ASSUME EIGHT CHAIN",                    concept_assume_waves,            D, l_mainstream,
    UC_none, cr_li_lo,      1, 1},
   {"ASSUME TRADE BY",                       concept_assume_waves,            D, l_mainstream,
    UC_none, cr_li_lo,      1, 2},
   {"ASSUME DPT",                            concept_assume_waves,            D, l_mainstream,
    UC_none, cr_2fl_only,   1, 1},
   {"ASSUME CDPT",                           concept_assume_waves,            D, l_mainstream,
    UC_none, cr_2fl_only,   1, 2},
   {"ASSUME FACING LINES",                   concept_assume_waves,            D, l_mainstream,
    UC_none, cr_li_lo,      0, 1},
   {"ASSUME BACK-TO-BACK LINES",             concept_assume_waves,            D, l_mainstream,
    UC_none, cr_li_lo,      0, 2},
   {"ASSUME 1/4 BOX",                        concept_assume_waves,            D, l_mainstream,
    UC_none, cr_quarterbox, 1, 0},
   {"ASSUME RIGHT 1/4 BOX",                  concept_assume_waves,            D, l_mainstream,
    UC_none, cr_quarterbox, 1, 1},
   {"ASSUME LEFT 1/4 BOX",                   concept_assume_waves,            D, l_mainstream,
    UC_none, cr_quarterbox, 1, 2},
   {"ASSUME 3/4 BOX",                        concept_assume_waves,            D, l_mainstream,
    UC_none, cr_threequarterbox, 1, 0},
   {"ASSUME RIGHT 3/4 BOX",                  concept_assume_waves,            D, l_mainstream,
    UC_none, cr_threequarterbox, 1, 1},
   {"ASSUME LEFT 3/4 BOX",                   concept_assume_waves,            D, l_mainstream,
    UC_none, cr_threequarterbox, 1, 2},
   {"ASSUME GENERAL DIAMONDS",               concept_assume_waves,            D, l_mainstream,
    UC_none, cr_diamond_like,0, 0},
   {"ASSUME GENERAL 1/4 TAGS",               concept_assume_waves,            D, l_mainstream,
    UC_none, cr_qtag_like,  0, 0},
   {"ASSUME 1/4 TAGS",                       concept_assume_waves,            D, l_mainstream,
    UC_none, cr_real_1_4_tag, 0, 0},
   {"ASSUME RIGHT 1/4 TAGS",                 concept_assume_waves,            D, l_mainstream,
    UC_none, cr_jleft,      0, 2},
   {"ASSUME LEFT 1/4 TAGS",                  concept_assume_waves,            D, l_mainstream,
    UC_none, cr_jright,     0, 2},
   {"ASSUME 3/4 TAGS",                       concept_assume_waves,            D, l_mainstream,
    UC_none, cr_real_3_4_tag, 0, 0},
   {"ASSUME RIGHT 3/4 TAGS",                 concept_assume_waves,            D, l_mainstream,
    UC_none, cr_jright,     0, 1},
   {"ASSUME LEFT 3/4 TAGS",                  concept_assume_waves,            D, l_mainstream,
    UC_none, cr_jleft,      0, 1},
   {"ASSUME 1/4 LINES",                      concept_assume_waves,            D, l_mainstream,
    UC_none, cr_real_1_4_line, 0, 0},
   {"ASSUME RIGHT 1/4 LINES",                concept_assume_waves,            D, l_mainstream,
    UC_none, cr_ijleft,     0, 2},
   {"ASSUME LEFT 1/4 LINES",                 concept_assume_waves,            D, l_mainstream,
    UC_none, cr_ijright,    0, 2},
   {"ASSUME 3/4 LINES",                      concept_assume_waves,            D, l_mainstream,
    UC_none, cr_real_3_4_line, 0, 0},
   {"ASSUME RIGHT 3/4 LINES",                concept_assume_waves,            D, l_mainstream,
    UC_none, cr_ijright,    0, 1},
   {"ASSUME LEFT 3/4 LINES",                 concept_assume_waves,            D, l_mainstream,
    UC_none, cr_ijleft,     0, 1},
   {"ASSUME NORMAL DIAMONDS",                concept_assume_waves,            D, l_mainstream,
    UC_none, cr_jright,     4, 0},
   {"ASSUME FACING DIAMONDS",                concept_assume_waves,            D, l_mainstream,
    UC_none, cr_jleft,      4, 0},
   {"ASSUME NORMAL INTERLOCKED DIAMONDS",    concept_assume_waves,            D, l_mainstream,
    UC_none, cr_ijright,    4, 0},
   {"ASSUME FACING INTERLOCKED DIAMONDS",    concept_assume_waves,            D, l_mainstream,
    UC_none, cr_ijleft,     4, 0},
   {"ASSUME HOURGLASS",                      concept_assume_waves,            D, l_mainstream,
    UC_none, cr_hourglass, 0, 0},
   {"ASSUME GALAXY",                         concept_assume_waves,            D, l_mainstream,
    UC_none, cr_galaxy, 0, 0},
   {"ASSUME SPLIT SQUARE THRU SETUP",        concept_assume_waves,            D, l_mainstream,
    UC_none, cr_split_square_setup, 2, 1},
   {"ASSUME LIFT-OFF SETUP",                 concept_assume_waves,            D, l_mainstream,
    UC_none, cr_liftoff_setup, 2, 1},
   {"ASSUME I SETUP",                        concept_assume_waves,            D, l_mainstream,
    UC_none, cr_i_setup, 2, 0},
   {"ASSUME NORMAL CASTS",                   concept_assume_waves,            D, l_mainstream,
    UC_none, cr_alwaysfail, 0, 0},
   {"WITH ACTIVE PHANTOMS",                  concept_active_phantoms,         D, l_mainstream,
    UC_none},
   ...
   {"@9/@9",                                 concept_fractional,            F+D, l_mainstream,
    UC_none, 0},
   {"@9/@9 OF",                              concept_fractional,            F+D, l_mainstream,
    UC_none, 0},
   {"1-@9/@9",                               concept_fractional,            F+D, l_mainstream,
    UC_none, 2},
   {"MIDDLE @9/@9 OF",                       concept_fractional,            F+D, l_mainstream,
    UC_none, 3},
   {"DO THE LAST @9/@9",                     concept_fractional,            F+D, l_mainstream,
    UC_none, 1},
   {"LAST @9/@9 OF",                         concept_fractional,            F+D, l_mainstream,
    UC_none, 1},
   ...
   {"OUTSIDES",                              concept_centers_or_ends,         D, l_mainstream,
    UC_none, selector_ends, false},
