...
const concept_descriptor concept_centers_concept = {
   "centers????", concept_centers_or_ends, 1, l_xyz, UC_none, selector_centers, false};
const concept_descriptor concept_heads_concept = {
   "HEADS", concept_so_and_so_only, 1, l_xyz, UC_none, selector_heads, false};
const concept_descriptor concept_sides_concept = {
   "SIDES", concept_so_and_so_only, 1, l_xyz, UC_none, selector_sides, false};
...
concept_descriptor conzept::unsealed_concept_descriptor_table[] = {
   ...
   {"@K ARE COUPLES TWOSOME",                concept_some_are_tandem,       F+D, l_c3a,
   ...
   {"PHANTOM DIAMONDS",                      concept_do_phantom_diamonds,     D, l_c1,
    UC_pd, phantest_first_or_both, CMD_MISC__VERIFY_DMD_LIKE, MPKIND__CONCPHAN},
   {"PHANTOM DIAMOND SPOTS",                 concept_do_phantom_diamonds,     D, l_c1,
    UC_pds, phantest_first_or_both, 0, MPKIND__CONCPHAN},
   {"PHANTOM 1/4 TAGS",                      concept_do_phantom_diamonds,     D, l_c1,
    UC_p1, phantest_first_or_both, CMD_MISC__VERIFY_1_4_TAG, MPKIND__CONCPHAN},
   {"PHANTOM 3/4 TAGS",                      concept_do_phantom_diamonds,     D, l_c1,
    UC_p3, phantest_first_or_both, CMD_MISC__VERIFY_3_4_TAG, MPKIND__CONCPHAN},
   {"PHANTOM 1/4 LINES",                     concept_do_phantom_diamonds,     D, l_c1,
    UC_none, phantest_first_or_both, CMD_MISC__VERIFY_REAL_1_4_LINE, MPKIND__CONCPHAN},
   {"PHANTOM 3/4 LINES",                     concept_do_phantom_diamonds,     D, l_c1,
    UC_none, phantest_first_or_both, CMD_MISC__VERIFY_REAL_3_4_LINE, MPKIND__CONCPHAN},
   {"PHANTOM GENERAL 1/4 TAGS",              concept_do_phantom_diamonds,     D, l_c1,
    UC_pgt, phantest_first_or_both, CMD_MISC__VERIFY_QTAG_LIKE, MPKIND__CONCPHAN},
   {"PHANTOM EIGHT CHAIN",                   concept_assume_waves,            D, l_xyz,
    UC_none, cr_li_lo,      1, 1},
   {"PHANTOM TRADE BY",                      concept_assume_waves,            D, l_xyz,
    UC_none, cr_li_lo,      1, 2},
   {"PHANTOM DPT",                           concept_assume_waves,            D, l_xyz,
    UC_none, cr_2fl_only,   1, 1},
   {"PHANTOM CDPT",                          concept_assume_waves,            D, l_xyz,
    UC_none, cr_2fl_only,   1, 2},
   {"PHANTOM FACING LINES",                  concept_assume_waves,            D, l_xyz,
    UC_none, cr_li_lo,      0, 1},
   {"PHANTOM BACK-TO-BACK LINES",            concept_assume_waves,            D, l_xyz,
    UC_none, cr_li_lo,      0, 2},
   {"PHANTOM TWO-FACED LINES",               concept_assume_waves,            D, l_xyz,
    UC_none, cr_2fl_only,   0, 0},
   {"PHANTOM ONE-FACED LINES",               concept_assume_waves,            D, l_xyz,
    UC_none, cr_1fl_only,   0, 0},
   {"PHANTOM INVERTED LINES",                concept_assume_waves,            D, l_xyz,
    UC_none, cr_magic_only, 0, 0},
   {"PHANTOM TIDAL LINE",                    concept_assume_waves,            D, l_xyz,
    UC_none, cr_tidal_line, 0, 0},
   {"PHANTOM TIDAL WAVE",                    concept_assume_waves,            D, l_xyz,
    UC_none, cr_tidal_wave, 0, 0},
   {"PHANTOM TIDAL TWO-FACED-LINE",          concept_assume_waves,            D, l_xyz,
    UC_none, cr_tidal_2fl, 0, 0},
   {"PHANTOM TIDAL COLUMN",                  concept_assume_waves,            D, l_xyz,
    UC_none, cr_tidal_line, 1, 0},
   {"PHANTOM HOURGLASS",                     concept_assume_waves,            D, l_xyz,
    UC_none, cr_hourglass, 0, 0},
   {"PHANTOM GALAXY",                        concept_assume_waves,            D, l_xyz,
    UC_none, cr_galaxy, 0, 0},
   {"PHANTOM SPLIT SQUARE THRU SETUP",       concept_assume_waves,            D, l_xyz,
    UC_none, cr_split_square_setup, 2, 1},
   {"PHANTOM LIFT-OFF SETUP",                concept_assume_waves,            D, l_xyz,
    UC_none, cr_liftoff_setup, 2, 1},
   {"PHANTOM I SETUP",                       concept_assume_waves,            D, l_xyz,
    UC_none, cr_i_setup, 2, 0},
   ...
   {"TWIN PHANTOM DIAMOND SPOTS",            concept_do_twinphantom_diamonds, D, l_c4,
    UC_none, phantest_impossible, CONCPROP__NEEDK_TWINDMD, 0, 0},
   ...
   {"TWIN PHANTOM POINT-TO-POINT DIAMOND SPOTS", concept_do_twinphantom_diamonds,D, l_c4,
    UC_none, phantest_impossible, CONCPROP__NEEDK_TWINDMD, 0, 1},
   ...
   {"TWIN PHANTOM RIGGERS",                  concept_do_divided_bones,        D, l_c4,
    UC_none, phantest_impossible, 1, 0, 0},
   {"TWIN PHANTOM THARS",                    concept_do_divided_bones,        D, l_c4,
    UC_none, phantest_impossible, 2, 0, 0},
   {"TWIN PHANTOM ALAMOS",                   concept_do_divided_bones,        D, l_c4,
    UC_none, phantest_impossible, 3, 0, 0},
   ...
   {"BIG BLOCK DIAMONDS",                    concept_do_phantom_2x4,          D, l_c3,
    UC_none, phantest_only_one, DISTORTKEY_DIST_CLW*16+0, MPKIND__NONE, spcmap_bbdmds},
   ...
   {"OFFSET LINE",                           concept_distorted,               D, l_c2,
    UC_none, disttest_offset, 0, 0, DISTORTKEY_OFFSCLWBI_SINGULAR*16+1},
   ...
   {"DISTORTED LINES",                       concept_distorted,               D, l_c1,
   ...
   {"BENT LINES",                            concept_dblbent,                 D, l_c4,
    UC_none, 1},
   {"DOUBLE BENT LINES",                     concept_dblbent,                 D, l_c4,
    UC_none, 32+1},
   ...
   {"OFFSET WAVE",                           concept_distorted,               D, l_c2,
    UC_none, disttest_offset, 0, 0, DISTORTKEY_OFFSCLWBI_SINGULAR*16+3},
   ...
   {"DISTORTED WAVES",                       concept_distorted,               D, l_c1,
   ...
   {"BENT WAVES",                            concept_dblbent,                 D, l_c4,
    UC_none, 3},
   {"DOUBLE BENT WAVES",                     concept_dblbent,                 D, l_c4,
    UC_none, 32+3},
   ...
   {"OFFSET COLUMN",                         concept_distorted,               D, l_c2,
    UC_none, disttest_offset, 0, 0, DISTORTKEY_OFFSCLWBI_SINGULAR*16+0},
   ...
   {"DISTORTED COLUMNS",                     concept_distorted,               D, l_c1,
   ...
   {"BENT COLUMNS",                          concept_dblbent,                 D, l_c4,
    UC_none, 0},
   {"DOUBLE BENT COLUMNS",                   concept_dblbent,                 D, l_c4,
    UC_none, 32+0},
   ...
   {"OFFSET BOX",                            concept_distorted,               D, l_c2,
    UC_none, disttest_offset, 0, 0, DISTORTKEY_OFFSCLWBI_SINGULAR*16+4},
   {"OFFSET 1X4",                            concept_distorted,               D, l_c2,
    UC_none, disttest_offset, 0, 0, DISTORTKEY_OFFSCLWBI_SINGULAR*16+6},
   ...
   {"OVERLAPPED WAVES",                      concept_overlapped_diamond,      D, l_c4,
    UC_none, 3},
   {"OVERLAPPED COLUMNS",                    concept_overlapped_diamond,      D, l_c4,
    UC_none, 0},
   ...
   {"DISTORTED BLOCKS",                      concept_misc_distort,            D, l_c4a,
    UC_none, 5, 0, 0},
   {"LEFT",                                  concept_left,                  L+D, l_xyz,
    UC_left},
   {"REVERSE",                               concept_reverse,               L+D, l_xyz,
    UC_none},
   {"CROSS",                                 concept_cross,                 L+D, l_xyz,
    UC_cross},
   {"SINGLE",                                concept_single,                L+D, l_xyz,
    UC_none},
   {"SINGLE FILE",                           concept_singlefile,            L+D, l_xyz,
   ...
   {"MATRIX",                                concept_matrix,                G+D, l_c4,
    UC_none},
   {"ASSUME WAVES",                          concept_assume_waves,            D, l_xyz,
    UC_none, cr_wave_only,  0, 0},
   {"ASSUME MINIWAVES",                      concept_assume_waves,            D, l_xyz,
    UC_none, cr_miniwaves,  0, 0},
   {"ASSUME COUPLES",                        concept_assume_waves,            D, l_xyz,
    UC_none, cr_couples_only,0, 0},
   {"ASSUME TWO-FACED LINES",                concept_assume_waves,            D, l_xyz,
    UC_none, cr_2fl_only,   0, 0},
   {"ASSUME ONE-FACED LINES",                concept_assume_waves,            D, l_xyz,
    UC_none, cr_1fl_only,   0, 0},
   {"ASSUME INVERTED LINES",                 concept_assume_waves,            D, l_xyz,
    UC_none, cr_magic_only, 0, 0},
   {"ASSUME TIDAL LINE",                     concept_assume_waves,            D, l_xyz,
    UC_none, cr_tidal_line, 0, 0},
   {"ASSUME TIDAL WAVE",                     concept_assume_waves,            D, l_xyz,
    UC_none, cr_tidal_wave, 0, 0},
   {"ASSUME TIDAL TWO-FACED-LINE",           concept_assume_waves,            D, l_xyz,
    UC_none, cr_tidal_2fl, 0, 0},
   {"ASSUME TIDAL COLUMN",                   concept_assume_waves,            D, l_xyz,
    UC_none, cr_tidal_line, 1, 0},
   {"ASSUME NORMAL BOXES",                   concept_assume_waves,            D, l_xyz,
    UC_none, cr_wave_only,  2, 0},
   {"ASSUME INVERTED BOXES",                 concept_assume_waves,            D, l_xyz,
    UC_none, cr_magic_only, 2, 0},
   {"ASSUME NORMAL COLUMNS",                 concept_assume_waves,            D, l_xyz,
    UC_none, cr_wave_only,  1, 0},
   {"ASSUME COLUMNS",                        concept_assume_waves,            D, l_xyz,
    UC_none, cr_wave_only,  1, 0},
   {"ASSUME RIGHT COLUMNS",                  concept_assume_waves,            D, l_xyz,
    UC_none, cr_wave_only,  1, 1},
   {"ASSUME LEFT COLUMNS",                   concept_assume_waves,            D, l_xyz,
    UC_none, cr_wave_only,  1, 2},
   {"ASSUME MAGIC COLUMNS",                  concept_assume_waves,            D, l_xyz,
    UC_none, cr_magic_only, 1, 0},
   {"ASSUME EIGHT CHAIN",                    concept_assume_waves,            D, l_xyz,
    UC_none, cr_li_lo,      1, 1},
   {"ASSUME TRADE BY",                       concept_assume_waves,            D, l_xyz,
    UC_none, cr_li_lo,      1, 2},
   {"ASSUME DPT",                            concept_assume_waves,            D, l_xyz,
    UC_none, cr_2fl_only,   1, 1},
   {"ASSUME CDPT",                           concept_assume_waves,            D, l_xyz,
    UC_none, cr_2fl_only,   1, 2},
   {"ASSUME FACING LINES",                   concept_assume_waves,            D, l_xyz,
    UC_none, cr_li_lo,      0, 1},
   {"ASSUME BACK-TO-BACK LINES",             concept_assume_waves,            D, l_xyz,
    UC_none, cr_li_lo,      0, 2},
   {"ASSUME 1/4 BOX",                        concept_assume_waves,            D, l_xyz,
    UC_none, cr_quarterbox, 1, 0},
   {"ASSUME RIGHT 1/4 BOX",                  concept_assume_waves,            D, l_xyz,
    UC_none, cr_quarterbox, 1, 1},
   {"ASSUME LEFT 1/4 BOX",                   concept_assume_waves,            D, l_xyz,
    UC_none, cr_quarterbox, 1, 2},
   {"ASSUME 3/4 BOX",                        concept_assume_waves,            D, l_xyz,
    UC_none, cr_threequarterbox, 1, 0},
   {"ASSUME RIGHT 3/4 BOX",                  concept_assume_waves,            D, l_xyz,
    UC_none, cr_threequarterbox, 1, 1},
   {"ASSUME LEFT 3/4 BOX",                   concept_assume_waves,            D, l_xyz,
    UC_none, cr_threequarterbox, 1, 2},
   {"ASSUME GENERAL DIAMONDS",               concept_assume_waves,            D, l_xyz,
    UC_none, cr_diamond_like,0, 0},
   {"ASSUME GENERAL 1/4 TAGS",               concept_assume_waves,            D, l_xyz,
    UC_none, cr_qtag_like,  0, 0},
   {"ASSUME 1/4 TAGS",                       concept_assume_waves,            D, l_xyz,
    UC_none, cr_real_1_4_tag, 0, 0},
   {"ASSUME RIGHT 1/4 TAGS",                 concept_assume_waves,            D, l_xyz,
    UC_none, cr_jleft,      0, 2},
   {"ASSUME LEFT 1/4 TAGS",                  concept_assume_waves,            D, l_xyz,
    UC_none, cr_jright,     0, 2},
   {"ASSUME 3/4 TAGS",                       concept_assume_waves,            D, l_xyz,
    UC_none, cr_real_3_4_tag, 0, 0},
   {"ASSUME RIGHT 3/4 TAGS",                 concept_assume_waves,            D, l_xyz,
    UC_none, cr_jright,     0, 1},
   {"ASSUME LEFT 3/4 TAGS",                  concept_assume_waves,            D, l_xyz,
    UC_none, cr_jleft,      0, 1},
   {"ASSUME 1/4 LINES",                      concept_assume_waves,            D, l_xyz,
    UC_none, cr_real_1_4_line, 0, 0},
   {"ASSUME RIGHT 1/4 LINES",                concept_assume_waves,            D, l_xyz,
    UC_none, cr_ijleft,     0, 2},
   {"ASSUME LEFT 1/4 LINES",                 concept_assume_waves,            D, l_xyz,
    UC_none, cr_ijright,    0, 2},
   {"ASSUME 3/4 LINES",                      concept_assume_waves,            D, l_xyz,
    UC_none, cr_real_3_4_line, 0, 0},
   {"ASSUME RIGHT 3/4 LINES",                concept_assume_waves,            D, l_xyz,
    UC_none, cr_ijright,    0, 1},
   {"ASSUME LEFT 3/4 LINES",                 concept_assume_waves,            D, l_xyz,
    UC_none, cr_ijleft,     0, 1},
   {"ASSUME NORMAL DIAMONDS",                concept_assume_waves,            D, l_xyz,
    UC_none, cr_jright,     4, 0},
   {"ASSUME FACING DIAMONDS",                concept_assume_waves,            D, l_xyz,
    UC_none, cr_jleft,      4, 0},
   {"ASSUME NORMAL INTERLOCKED DIAMONDS",    concept_assume_waves,            D, l_xyz,
    UC_none, cr_ijright,    4, 0},
   {"ASSUME FACING INTERLOCKED DIAMONDS",    concept_assume_waves,            D, l_xyz,
    UC_none, cr_ijleft,     4, 0},
   {"ASSUME HOURGLASS",                      concept_assume_waves,            D, l_xyz,
    UC_none, cr_hourglass, 0, 0},
   {"ASSUME GALAXY",                         concept_assume_waves,            D, l_xyz,
    UC_none, cr_galaxy, 0, 0},
   {"ASSUME SPLIT SQUARE THRU SETUP",        concept_assume_waves,            D, l_xyz,
    UC_none, cr_split_square_setup, 2, 1},
   {"ASSUME LIFT-OFF SETUP",                 concept_assume_waves,            D, l_xyz,
    UC_none, cr_liftoff_setup, 2, 1},
   {"ASSUME I SETUP",                        concept_assume_waves,            D, l_xyz,
    UC_none, cr_i_setup, 2, 0},
   {"ASSUME NORMAL CASTS",                   concept_assume_waves,            D, l_xyz,
    UC_none, cr_alwaysfail, 0, 0},
   {"WITH ACTIVE PHANTOMS",                  concept_active_phantoms,         D, l_xyz,
    UC_none},
   ...
   {"RECTIFY",                               concept_rectify,                 D, l_c4,
    UC_none},
   ...
   {"@6 ARE @b STABLE",                      concept_so_and_so_frac_stable, F+D, l_c4,
    UC_none, true,  true},
   {"PARANOID",                              concept_special_sequential_no_2nd,D, l_c4,
    UC_none, part_key_paranoid, false},
   {"@6 ARE PARANOID",                       concept_special_sequential_sel_no_2nd,F+D, l_c4,
    UC_none, part_key_paranoid, true},
   ...
   {"OUTERACTING",                           concept_outeracting,             D, l_c4,
    UC_none},
   {"STRETCH",                               concept_stretch,                 D, l_c1,
    UC_none},
   {"STRETCHED SETUP",                       concept_stretched_setup,         D, l_c2,
    UC_none, 16},
   {"STRETCHED BOX",                         concept_stretched_setup,         D, l_c2,
    UC_none, 18},
   {"STRETCHED LINE",                        concept_stretched_setup,         D, l_c2,
    UC_none, 1},
   {"STRETCHED WAVE",                        concept_stretched_setup,         D, l_c2,
    UC_none, 3},
   {"STRETCHED COLUMN",                      concept_stretched_setup,         D, l_c2,
    UC_none, 4},
   {"STRETCHED DIAMOND",                     concept_stretched_setup,         D, l_c3a,
    UC_none, 19},
   {"STRETCHED 1/4 TAG",                     concept_stretched_setup,         D, l_c3a,
    UC_none, 19},
   {"STRETCHED 3/4 TAG",                     concept_stretched_setup,         D, l_c3a,
    UC_none, 19},
   {"STRETCHED",                             concept_stretched_setup,         D, l_c3a,
    UC_none, 20},
   {"FERRIS",                                concept_ferris,                  D, l_c3x,
    UC_none, 0, 0},
   {"RELEASE",                               concept_ferris,                  D, l_c3a,
    UC_none, 1, 0},
   {"CENTERS AND ENDS",                      concept_centers_and_ends,        0, l_xyz,
    UC_none, selector_centers, false},
   {"CENTER 6/OUTER 2",                      concept_centers_and_ends,        0, l_xyz,
    UC_none, selector_center6, false},
   {"CENTER 2/OUTER 6",                      concept_centers_and_ends,        0, l_xyz,
    UC_none, selector_center2, false},
   {"ENDS CONCENTRIC",                       concept_centers_or_ends,         D, l_c1,
    UC_none, selector_ends,    true},
   {"OUTSIDES CONCENTRIC",                   concept_centers_or_ends,         D, l_c1,
    UC_none, selector_ends,    true},
   ...
   {"CHECKERBOARD",                          concept_checkerboard,            D, l_c3a,
    UC_none, s1x4, 0},
   {"CHECKER BOARD",                         concept_checkerboard,            D, l_c3a,
    UC_none, s1x4, 0},
   {"CHECKERBOX",                            concept_checkerboard,            D, l_c3a,
    UC_none, s2x2, 0},
   {"CHECKER BOX",                           concept_checkerboard,            D, l_c3a,
    UC_none, s2x2, 0},
   {"CHECKERDIAMOND",                        concept_checkerboard,            D, l_c4a,
    UC_none, sdmd, 0},
   {"CHECKER DIAMOND",                         concept_checkerboard,            D, l_c4a,
    UC_none, sdmd, 0},
   {"@6 PREFERRED FOR TRADE, CHECKERBOARD",  concept_sel_checkerboard,        D, l_c3a,
    UC_none, s1x4, 8},
   {"@6 PREFERRED FOR TRADE, CHECKER BOARD", concept_sel_checkerboard,        D, l_c3a,
    UC_none, s1x4, 8},
   {"@6 PREFERRED FOR TRADE, CHECKERBOX",    concept_sel_checkerboard,        D, l_c3a,
    UC_none, s2x2, 8},
   {"@6 PREFERRED FOR TRADE, CHECKER BOX",   concept_sel_checkerboard,        D, l_c3a,
    UC_none, s2x2, 8},
   {"@6 PREFERRED FOR TRADE, CHECKERDIAMOND",concept_sel_checkerboard,        D, l_c4a,
    UC_none, sdmd, 8},
   {"@6 PREFERRED FOR TRADE, CHECKER DIAMOND",concept_sel_checkerboard,       D, l_c4a,
    UC_none, sdmd, 8},
   // Another spelling.
   {"PREFER THE @6 FOR THE TRADE, CHECKERBOARD",concept_sel_checkerboard,     D, l_c3a,
    UC_none, s1x4, 8},
   {"PREFER THE @6 FOR THE TRADE, CHECKER BOARD",concept_sel_checkerboard,    D, l_c3a,
    UC_none, s1x4, 8},
   {"PREFER THE @6 FOR THE TRADE, CHECKERBOX", concept_sel_checkerboard,      D, l_c3a,
    UC_none, s2x2, 8},
   {"PREFER THE @6 FOR THE TRADE, CHECKER BOX",concept_sel_checkerboard,      D, l_c3a,
    UC_none, s2x2, 8},
   {"PREFER THE @6 FOR THE TRADE, CHECKERDIAMOND",concept_sel_checkerboard,   D, l_c4a,
    UC_none, sdmd, 8},
   {"PREFER THE @6 FOR THE TRADE, CHECKER DIAMOND",concept_sel_checkerboard,  D, l_c4a,
    UC_none, sdmd, 8},
   {"ORBITBOARD",                            concept_checkerboard,            D, l_c4,
    UC_none, s1x4, 2},
   {"ORBIT BOARD",                           concept_checkerboard,            D, l_c4,
    UC_none, s1x4, 2},
   {"ORBITBOX",                              concept_checkerboard,            D, l_c4,
    UC_none, s2x2, 2},
   {"ORBIT BOX",                             concept_checkerboard,            D, l_c4,
    UC_none, s2x2, 2},
   {"ORBITDIAMOND",                          concept_checkerboard,            D, l_c4,
    UC_none, sdmd, 2},
   {"ORBIT DIAMOND",                         concept_checkerboard,            D, l_c4,
    UC_none, sdmd, 2},
   {"LEFT ORBITBOARD",                       concept_checkerboard,            D, l_c4,
    UC_none, s1x4, 4},
   {"LEFT ORBIT BOARD",                      concept_checkerboard,            D, l_c4,
    UC_none, s1x4, 4},
   {"LEFT ORBITBOX",                         concept_checkerboard,            D, l_c4,
    UC_none, s2x2, 4},
   {"LEFT ORBIT BOX",                        concept_checkerboard,            D, l_c4,
    UC_none, s2x2, 4},
   {"LEFT ORBITDIAMOND",                     concept_checkerboard,            D, l_c4,
    UC_none, sdmd, 4},
   {"LEFT ORBIT DIAMOND",                    concept_checkerboard,            D, l_c4,
    UC_none, sdmd, 4},
   {"TWIN ORBITBOARD",                       concept_checkerboard,            D, l_c4,
    UC_none, s1x4, 3},
   {"TWIN ORBIT BOARD",                      concept_checkerboard,            D, l_c4,
    UC_none, s1x4, 3},
   {"TWIN ORBITBOX",                         concept_checkerboard,            D, l_c4,
    UC_none, s2x2, 3},
   {"TWIN ORBIT BOX",                        concept_checkerboard,            D, l_c4,
    UC_none, s2x2, 3},
   {"TWIN ORBITDIAMOND",                     concept_checkerboard,            D, l_c4,
    UC_none, sdmd, 3},
   {"TWIN ORBIT DIAMOND",                    concept_checkerboard,            D, l_c4,
    UC_none, sdmd, 3},
   ...
   {"ANCHOR THE @6",                         concept_anchor,                F+D, l_c4,
    UC_none},
   {"@6",                                    concept_so_and_so_only,        Y+D, l_xyz,
    UC_none, selective_key_plain, 0, 0},
   {"@6 (while the others)",                 concept_some_vs_others,          0, l_xyz,
   ...
   {"@6 DO YOUR PART",                       concept_so_and_so_only,        F+D, l_xyz,
    UC_none, selective_key_dyp, 0, 0},
   {"@6 DO YOUR PART (while the others)",    concept_some_vs_others,          F, l_xyz,
   ...
   {"@6 LEAD FOR A",                         concept_so_and_so_only,          D, l_xyz,
    UC_none, selective_key_lead_for_a, 0, 0},
   {"PROMENADE, @6 LEAD FOR A",              concept_so_and_so_only,          D, l_xyz,
    UC_none, selective_key_promenade_and_lead_for_a, 0, 0},
   {"@6 MOVE IN AND",                        concept_move_in_and,             D, l_xyz,
    UC_none},
   {"two calls in succession",               concept_sequential,              0, l_xyz,
    UC_none},
   ...
   {"TWICE",                                 concept_n_times_const,         F+D, l_xyz,
    UC_none, 0, 2},
   {"THRICE",                                concept_n_times_const,         F+D, l_xyz,
    UC_none, 0, 3},
   {"@9 TIMES",                              concept_n_times,               F+D, l_xyz,
    UC_none, 1},
   {"@9/@9",                                 concept_fractional,            F+D, l_xyz,
    UC_none, 0},
   {"@9/@9 OF",                              concept_fractional,            F+D, l_xyz,
    UC_none, 0},
   {"1-@9/@9",                               concept_fractional,            F+D, l_xyz,
    UC_none, 2},
   {"MIDDLE @9/@9 OF",                       concept_fractional,            F+D, l_xyz,
    UC_none, 3},
   {"DO THE LAST @9/@9",                     concept_fractional,            F+D, l_xyz,
    UC_none, 1},
   {"LAST @9/@9 OF",                         concept_fractional,            F+D, l_xyz,
    UC_none, 1},
   {"REVERSE ORDER",                         concept_meta,                    D, l_xyz,
   ...
   {"REVERSE ECHO",                          concept_meta,                  G+D, l_c3,
   ...
   {"RANDOMIZE BETWEEN",                     concept_meta,                  G+D, l_c4,
    UC_none, meta_key_randomize, 2},
   {"TRIPLE RANDOMIZE AMONG",                concept_meta,                  G+D, l_c4,
    UC_none, meta_key_randomize, 3},
   ...
   {"TALL 6",                                concept_tallshort6,              D, l_c4a,
    UC_none, 0},
   {"SHORT 6",                               concept_tallshort6,              D, l_c4a,
    UC_none, 1},
   ...
   {"COMMON END WAVES",                      concept_common_spot,             D, l_c4,
    UC_none, 0x10, CMD_MISC__VERIFY_WAVES, 0},
   {"COMMON CENTER LINES",                   concept_common_spot,             D, l_c4,
    UC_none, 0x20, 0, 0},
   {"COMMON CENTER WAVES",                   concept_common_spot,             D, l_c4,
    UC_none, 0x20, CMD_MISC__VERIFY_WAVES, 0},
   {"COMMON SPOT WAVES",                     concept_common_spot,             D, l_c4,
    UC_none, 0x70, CMD_MISC__VERIFY_WAVES, 0},
   {"COMMON SPOT LINES",                     concept_common_spot,             D, l_c4,
    UC_none, 0x78, 0, 0},
   {"COMMON SPOT TWO-FACED LINES",           concept_common_spot,             D, l_c4,
    UC_none, 8, CMD_MISC__VERIFY_2FL, 0},
   // Not doing assumptions; makes wd54t fail.
   {"COMMON SPOT TIDAL WAVE",                concept_common_spot,             D, l_c4,
    UC_none, 0x1000, 0 /*CMD_MISC__VERIFY_WAVES*/, s1x16},
   {"COMMON SPOT TIDAL TWO-FACED LINE",      concept_common_spot,             D, l_c4,
    UC_none, 0x2000, 0 /*CMD_MISC__VERIFY_2FL*/, s1x16},
   {"COMMON SPOT TIDAL LINE",                concept_common_spot,             D, l_c4,
    UC_none, 0x4000, 0 /*CMD_MISC__VERIFY_LINES*/, s1x16},
   ...
   {"3X2",                                   concept_3x2,                   L+D, l_c1,
    UC_none},
   {"3X5",                                   concept_3x5,                   L+D, l_c4,
    UC_none},
   {"5X3",                                   concept_5x3,                   L+D, l_c4,
    UC_none},
   ...
   {"FAST",                                  concept_fast,                  L+D, l_c4,
    UC_none},
   {"CENTERS",                               concept_centers_or_ends,         D, l_xyz,
    UC_none, selector_centers, false},
   {"ENDS",                                  concept_centers_or_ends,         D, l_xyz,
    UC_none, selector_ends, false},
   {"OUTSIDES",                              concept_centers_or_ends,         D, l_xyz,
    UC_none, selector_ends, false},
   {"EACH 1X4",                              concept_each_1x4,                D, l_xyz,
    UC_none, 0, 0},
   {"EACH LINE",                             concept_each_1x4,                D, l_xyz,
    UC_none, 1, 0},
   {"EACH COLUMN",                           concept_each_1x4,                D, l_xyz,
    UC_none, 2, 0},
   {"EACH WAVE",                             concept_each_1x4,                D, l_xyz,
    UC_none, 3, 0},
   {"EACH BOX",                              concept_each_1x4,                D, l_xyz,
    UC_none, 0, 2},
   {"EACH DIAMOND",                          concept_each_1x4,                D, l_xyz,
    UC_none, 0, 1},
   {"1x6 MATRIX",                            concept_create_matrix,           D, l_c3x,
    UC_none, s1x6, CONCPROP__NEEDK_1X6},
   {"1x8 MATRIX",                            concept_create_matrix,           D, l_c3x,
    UC_none, s1x8, CONCPROP__NEEDK_1X8},
   ...
   {"DRAG THE @6",                           concept_drag,                  F+D, l_c4,
    UC_none},
   {"DIAGNOSE",                              concept_diagnose,                D, l_xyz,
