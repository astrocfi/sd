...
concept_descriptor conzept::unsealed_concept_descriptor_table[] = {
   ...
   {"COUPLES DYNAMIC",                       concept_tandem,                  D, l_c4,
    UC_none, 0, 0,                    0x050, tandem_key_cpls},
   {"TANDEM DYNAMIC",                        concept_tandem,                  D, l_c4,
    UC_none, 0, 0,                    0x050, tandem_key_tand},
   {"SIAMESE DYNAMIC",                       concept_tandem,                  D, l_c4,
    UC_none, 0, 0,                    0x050, tandem_key_siam},
   {"COUPLES OF 3 DYNAMIC",                  concept_tandem,                  D, l_c4,
    UC_none, 0, 0,                    0x050, tandem_key_cpls3},
   {"TANDEMS OF 3 DYNAMIC",                  concept_tandem,                  D, l_c4,
    UC_none, 0, 0,                    0x050, tandem_key_tand3},
   {"SIAMESE OF 3 DYNAMIC",                  concept_tandem,                  D, l_c4,
    UC_none, 0, 0,                    0x050, tandem_key_siam3},
   {"COUPLES OF 4 DYNAMIC",                  concept_tandem,                  D, l_c4,
    UC_none, 0, 0,                    0x050, tandem_key_cpls4},
   {"TANDEMS OF 4 DYNAMIC",                  concept_tandem,                  D, l_c4,
    UC_none, 0, 0,                    0x050, tandem_key_tand4},
   {"SIAMESE OF 4 DYNAMIC",                  concept_tandem,                  D, l_c4,
    UC_none, 0, 0,                    0x050, tandem_key_siam4},
   {"BOXES DYNAMIC",                         concept_tandem,                  D, l_c4,
    UC_none, 0, 0,                    0x050, tandem_key_box},
   {"DIAMONDS DYNAMIC",                      concept_tandem,                  D, l_c4,
    UC_none, 0, 0,                    0x050, tandem_key_diamond},
   {"Y's DYNAMIC",                           concept_tandem,                  D, l_c4,
    UC_none, 0, 0,                    0x050, tandem_key_ys},
   {"SKEW DYNAMIC",                          concept_tandem,                  D, l_c4,
    UC_none, 0, 0,                    0x050, tandem_key_skew},
   {"GRUESOME DYNAMIC",                      concept_gruesome_tandem,         D, l_c4,
    UC_none, 0, CONCPROP__NEEDK_2X8,  0x053, tandem_key_cpls},
   {"GRUESOME COUPLES DYNAMIC",              concept_gruesome_tandem,         D, l_c4,
    UC_none, 0, CONCPROP__NEEDK_2X8,  0x052, tandem_key_cpls},
   {"GRUESOME TANDEM DYNAMIC",               concept_gruesome_tandem,         D, l_c4,
    UC_none, 0, CONCPROP__NEEDK_2X8,  0x052, tandem_key_tand},
   {"@K ARE COUPLES DYNAMIC",                concept_some_are_tandem,       F+D, l_c4,
    UC_none, 0, 0,                    0x150, tandem_key_cpls},
   {"@K ARE TANDEM DYNAMIC",                 concept_some_are_tandem,       F+D, l_c4,
    UC_none, 0, 0,                    0x150, tandem_key_tand},
   {"@K ARE COUPLES OF 3 DYNAMIC",           concept_some_are_tandem,       F+D, l_c4,
    UC_none, 0, 0,                    0x150, tandem_key_cpls3},
   {"@K ARE TANDEMS OF 3 DYNAMIC",           concept_some_are_tandem,       F+D, l_c4,
    UC_none, 0, 0,                    0x150, tandem_key_tand3},
   {"INSIDE TRIANGLES ARE DYNAMIC",          concept_tandem,                F+D, l_c4,
    UC_none, 0, 0,                    0x050, tandem_key_inside_tgls},
   {"OUTSIDE TRIANGLES ARE DYNAMIC",         concept_tandem,                F+D, l_c4,
    UC_none, 0, 0,                    0x050, tandem_key_outside_tgls},
   {"IN POINT TRIANGLES ARE DYNAMIC",        concept_tandem,                F+D, l_c4,
    UC_none, 0, 0,                    0x050, tandem_key_inpoint_tgls},
   {"OUT POINT TRIANGLES ARE DYNAMIC",       concept_tandem,                F+D, l_c4,
    UC_none, 0, 0,                    0x050, tandem_key_outpoint_tgls},
   {"WAVE-BASED TRIANGLES ARE DYNAMIC",      concept_tandem,                F+D, l_c4,
    UC_none, 0, 0,                    0x050, tandem_key_wave_tgls},
   {"TANDEM-BASED TRIANGLES ARE DYNAMIC",    concept_tandem,                F+D, l_c4,
    UC_none, 0, 0,                    0x050, tandem_key_tand_tgls},
   {"@k-BASED TRIANGLES ARE DYNAMIC",        concept_some_are_tandem,       F+D, l_c4,
    UC_none, 0, 0,                    0x150, tandem_key_anyone_tgls},
   {"3X1 TRIANGLES ARE DYNAMIC",             concept_tandem,                F+D, l_c4,
    UC_none, 0, 0,                    0x050, tandem_key_3x1tgls},
   // ----------------------------------------------------------------------------------
   {"COUPLES REVERSE DYNAMIC",               concept_tandem,                  D, l_c4,
    UC_none, 0, 0,                    0x090, tandem_key_cpls},
   {"TANDEM REVERSE DYNAMIC",                concept_tandem,                  D, l_c4,
    UC_none, 0, 0,                    0x090, tandem_key_tand},
   {"SIAMESE REVERSE DYNAMIC",               concept_tandem,                  D, l_c4,
    UC_none, 0, 0,                    0x090, tandem_key_siam},
   {"COUPLES OF 3 REVERSE DYNAMIC",          concept_tandem,                  D, l_c4,
    UC_none, 0, 0,                    0x090, tandem_key_cpls3},
   {"TANDEMS OF 3 REVERSE DYNAMIC",          concept_tandem,                  D, l_c4,
    UC_none, 0, 0,                    0x090, tandem_key_tand3},
   {"SIAMESE OF 3 REVERSE DYNAMIC",          concept_tandem,                  D, l_c4,
    UC_none, 0, 0,                    0x090, tandem_key_siam3},
   {"COUPLES OF 4 REVERSE DYNAMIC",          concept_tandem,                  D, l_c4,
    UC_none, 0, 0,                    0x090, tandem_key_cpls4},
   {"TANDEMS OF 4 REVERSE DYNAMIC",          concept_tandem,                  D, l_c4,
    UC_none, 0, 0,                    0x090, tandem_key_tand4},
   {"SIAMESE OF 4 REVERSE DYNAMIC",          concept_tandem,                  D, l_c4,
    UC_none, 0, 0,                    0x050, tandem_key_siam4},
   {"BOXES REVERSE DYNAMIC",                 concept_tandem,                  D, l_c4,
    UC_none, 0, 0,                    0x090, tandem_key_box},
   {"DIAMONDS REVERSE DYNAMIC",              concept_tandem,                  D, l_c4,
    UC_none, 0, 0,                    0x090, tandem_key_diamond},
   {"Y's REVERSE DYNAMIC",                   concept_tandem,                  D, l_c4,
    UC_none, 0, 0,                    0x090, tandem_key_ys},
   {"SKEW REVERSE DYNAMIC",                  concept_tandem,                  D, l_c4,
    UC_none, 0, 0,                    0x090, tandem_key_skew},
   {"GRUESOME REVERSE DYNAMIC",              concept_gruesome_tandem,         D, l_c4,
    UC_none, 0, CONCPROP__NEEDK_2X8,  0x093, tandem_key_cpls},
   {"GRUESOME COUPLES REVERSE DYNAMIC",      concept_gruesome_tandem,         D, l_c4,
    UC_none, 0, CONCPROP__NEEDK_2X8,  0x092, tandem_key_cpls},
   {"GRUESOME TANDEM REVERSE DYNAMIC",       concept_gruesome_tandem,         D, l_c4,
    UC_none, 0, CONCPROP__NEEDK_2X8,  0x092, tandem_key_tand},
   {"@K ARE COUPLES REVERSE DYNAMIC",        concept_some_are_tandem,       F+D, l_c4,
    UC_none, 0, 0,                    0x190, tandem_key_cpls},
   {"@K ARE TANDEM REVERSE DYNAMIC",         concept_some_are_tandem,       F+D, l_c4,
    UC_none, 0, 0,                    0x190, tandem_key_tand},
   {"@K ARE COUPLES OF 3 REVERSE DYNAMIC",   concept_some_are_tandem,       F+D, l_c4,
    UC_none, 0, 0,                    0x190, tandem_key_cpls3},
   {"@K ARE TANDEMS OF 3 REVERSE DYNAMIC",   concept_some_are_tandem,       F+D, l_c4,
    UC_none, 0, 0,                    0x190, tandem_key_tand3},
   {"INSIDE TRIANGLES ARE REVERSE DYNAMIC",  concept_tandem,                F+D, l_c4,
    UC_none, 0, 0,                    0x090, tandem_key_inside_tgls},
   {"OUTSIDE TRIANGLES ARE REVERSE DYNAMIC", concept_tandem,                F+D, l_c4,
    UC_none, 0, 0,                    0x090, tandem_key_outside_tgls},
   {"IN POINT TRIANGLES ARE REVERSE DYNAMIC",concept_tandem,                F+D, l_c4,
    UC_none, 0, 0,                    0x090, tandem_key_inpoint_tgls},
   {"OUT POINT TRIANGLES ARE REVERSE DYNAMIC",concept_tandem,               F+D, l_c4,
    UC_none, 0, 0,                    0x090, tandem_key_outpoint_tgls},
   {"WAVE-BASED TRIANGLES ARE REVERSE DYNAMIC",concept_tandem,              F+D, l_c4,
    UC_none, 0, 0,                    0x090, tandem_key_wave_tgls},
   {"TANDEM-BASED TRIANGLES ARE REVERSE DYNAMIC",concept_tandem,            F+D, l_c4,
    UC_none, 0, 0,                    0x090, tandem_key_tand_tgls},
   {"@k-BASED TRIANGLES ARE REVERSE DYNAMIC",concept_some_are_tandem,       F+D, l_c4,
    UC_none, 0, 0,                    0x190, tandem_key_anyone_tgls},
   {"3X1 TRIANGLES ARE REVERSE DYNAMIC",     concept_tandem,                F+D, l_c4,
   ...
   {"DOUBLE ECHO",                           concept_meta,                  G+D, l_c3,
    UC_none, meta_key_echo, 2},
   {"TRIPLE ECHO",                           concept_meta,                  G+D, l_c3,
    UC_none, meta_key_echo, 3},
   {"QUADRUPLE ECHO",                        concept_meta,                  G+D, l_c3,
