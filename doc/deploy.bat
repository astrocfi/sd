...
echo   be moved to the directory C:\sd_pre3281 and the new version
...
pause
echo on
if not exist "C:\Sd_pre3281" mkdir "C:\Sd_pre3281"
if exist "C:\Sd\sdtty.exe" copy C:\sd\sdtty.exe C:\Sd_pre3281\sdtty.exe
if exist "C:\Sd\sd.exe" copy C:\sd\sd.exe C:\Sd_pre3281\sd.exe
if exist "C:\Sd\mkcalls.exe" copy C:\sd\mkcalls.exe C:\Sd_pre3281\mkcalls.exe
if exist "C:\Sd\sd_calls.txt" copy C:\sd\sd_calls.txt C:\Sd_pre3281\sd_calls.txt
if exist "C:\Sd\sd_calls.dat" copy C:\sd\sd_calls.dat C:\Sd_pre3281\sd_calls.dat
:ok
